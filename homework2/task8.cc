...
void kBasedAdder(const Number a, const Number b, const Number k, const Number addition = 0);
...
std::out_of_range("Bad input data!") {}

void kBasedAdder(const Number a, const Number b, const Number k, const Number addition) {
